...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">New Stock In</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/transaction/purchases">Purchases</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="/purchases/purtambahproses" method="post">
                  {{ csrf_field() }}
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputSupplier1">Supplier</label>
                        <select class="form-control" name="supplier" id="exampleInputSupplier1">
